import photo from "./bgs.png";
import { ReactTyped } from "react-typed";
import "./login.css"
import photos from "./logo.png"
...
function Login() {
  ...
  const handleName = (event) => {
    setInfo([event.target.value, ...Info.slice(1)]);
  };
  
  const handlePasswd = (event) => {
    setInfo([...Info.slice(0, 1), event.target.value]);
  };
  return (
    <>
    <Header/>
    <section className="min-h-screen flex items-stretch text-white">
      ...
      >
        ...
        <div className="w-full px-24 z-10">
          ...
          <ReactTyped className="font-mono text-rose-500 text-4xl"
          strings={["Your journey starts with a tap.",

"Book smart. Fly easy.",

"One app. All destinations.",

"The sky is calling — we just made it easier to answer.",

"Flights made simple. Adventures made epic.",

"From click to takeoff — effortless bookings."
,
"Dream. Book. Fly."
,
"Go anywhere. Book anytime."
,
"No queues. No stress. Just take off."
,
"Take off without taking time."]}
          typeSpeed={120}
          backSpeed={100}
          loop
      ...
      {/* RIGHT FORM PANEL */}
      <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 z-0" id="t" style={{ backgroundColor: "#161616" }}>
            
        <div className="w-full py-6 z-20">
            <h1><img src={photos} id="lg"></img></h1>
          <h1 id="des" className="my-6 text-3xl font-bold">Login To <ReactTyped
          strings={["Be in Touch...", "Get Connected ..", "Get things.."]}
          typeSpeed={120}
          backSpeed={100}
          loop
        ...
        /></h1>
          ...
          {/* <p className="text-gray-100 mb-4">------ or use email your account -------</p> */}
          ...
          <form className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            ...
            {/* <div className="text-right text-gray-400 hover:underline hover:text-gray-100">
              <a id="fgp" href="#">Forgot your password?</a>
            </div> */}
            <div className="px-4 pb-2 pt-4">
              <button type="submit" onClick={handleLogin}  id="sign">
                Log in
              </button>
              <div id="lnk">           
                 <a id="fgp" href="#">Forgot your password ?</a>
...
//         <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: `url(${photo})` }}>
